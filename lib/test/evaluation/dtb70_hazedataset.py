...
class DTB70HazeDataset(BaseDataset):
    """
    ...
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.dtb70_haze_path
    ...
    def _construct_sequence(self, sequence_name):
        ...
        return Sequence(sequence_name, frames_list, 'dtb70_haze', ground_truth_rect.reshape(-1, 4))
