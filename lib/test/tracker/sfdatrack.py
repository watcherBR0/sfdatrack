...
class SFDATrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(SFDATrack, self).__init__(params)
        network = build_sfdatrack(params.cfg, training=False)
    ...
    def track_center(self, image, info: dict = None, vis=None, frame_path=None):
        ...
        with torch.no_grad():
            ...
            out_dict = self.network(template=self.z_dict1, search=x_dict.tensors)
