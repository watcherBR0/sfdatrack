...
def main():
    ...
    parser.add_argument('--save_dir', type=str, required=True, help='the directory to save checkpoints and logs')
    parser.add_argument('--seed', type=int, default=42, help='seed for random numbers')
    parser.add_argument('--use_lmdb', type=int, choices=[0, 1], default=0, help='whether datasets are in lmdb format')
    ...
    parser.add_argument('--use_wandb', type=int, choices=[0, 1], default=0, help='whether to use wandb')
    # for knowledge distillation
    parser.add_argument('--distill', type=int, choices=[0, 1], default=0, help='whether to use knowledge distillation')
